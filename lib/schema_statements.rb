...
p "===>create sql:"+create_sql
      ...
      def dump_schema_information #:nodoc:
        ...
        migrated = select_values("SELECT version FROM #{quote_table_name(sm_table)}")
...
p "schema table not found"
          create_table(sm_table, :id => false) do |schema_migrations_table|
            schema_migrations_table.column :appid, :string, :null => false
            schema_migrations_table.column :version, :string, :null => false
          end
          add_index sm_table, [:appid, :version], :unique => true,
