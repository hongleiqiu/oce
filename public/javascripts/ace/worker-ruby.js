...
define('ace/mode/ruby/ruby', ['require', 'exports', 'module' ], function(require, exports, module) {
	...
	parse: function parse(input) {
	    ...
	    console.log("this is "+ inspect(this));
	var uu=5;
	    console.log("this.uu "+ this.uu);
	
		console.log("lexer type is "+ typeof(this.lexer));
		...
		// console.log("set parseerror1" + typeof(this.yy.parseError));
		// 	        this.parseError = this.yy.parseError;
		// 	    } else {
		// 	console.log("set parseerror2 "+ typeof(this.yy.parseError));
		// 
	...
	console.log("this2 is "+inspect(this));
	console.log("line="+this.lexer.yylineno);
